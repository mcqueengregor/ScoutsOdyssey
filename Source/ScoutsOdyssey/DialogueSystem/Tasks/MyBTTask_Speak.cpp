...
UMyBTTask_Speak::UMyBTTask_Speak()
{
	...
	DialogueComponent_BlackboardKey.AddObjectFilter(this, GET_MEMBER_NAME_CHECKED(UMyBTTask_Speak, DialogueComponent_BlackboardKey), UDialogueComponent::StaticClass());
}
...
EBTNodeResult::Type UMyBTTask_Speak::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
	...
	DialogueComponent = Cast<UDialogueComponent>(BlackboardComponent->GetValueAsObject(DialogueComponent_BlackboardKey.SelectedKeyName));
